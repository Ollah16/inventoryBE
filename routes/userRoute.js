...
const { handleRegistration, handleLogin, handleUserCart, handleClearCart, handleRemoveItem, handleCartItem, addPersonalDetails, handleAddAddress, handleFetchAllOrders, handleFetchAddress, handleFetchPersonalDetails, handleVerifyPassword, handleAddressEdit, handleAddressDelete, } = require("../controller/userControl")
...
router.get('/fetchAllOrders', jwtMiddleWare, handleFetchAllOrders)
